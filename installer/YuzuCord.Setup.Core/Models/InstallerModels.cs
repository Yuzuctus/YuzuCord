...
namespace YuzuCord.Setup.Core.Models;
...
public sealed class BundleManifest
{
    ...
    public string ProductId { get; init; } = YuzuCordProduct.PersistedId;

    public string ProductName { get; init; } = YuzuCordProduct.Name;
